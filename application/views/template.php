	...
	<div class="col-md-12 nav-wrapper">
		<div class="navbar-header" style="width:100%;">
			...
			<ul class="nav navbar-nav navbar-right user-nav">
				...
				<img src="<?php echo base_url() ?>assets/img/avatar.jpg" class="img-circle avatar"
...
<div class="container-fluid mimin-wrapper">
		...
		<div class="sub-left-menu scroll">
			<ul class="nav nav-list">
				...
				<li class="time">
					...
					<p>
					<h3 class="animated fadeInRight"><?= date('d M, Y') ?></h3>
					</p>
				</li>
				<br>
				<br>
				<li class="ripple"><a href="<?php echo site_url('Dashboard') ?>"><span class="fa fa-home"></span>Dashborad</a>
				</li>
				<li class="ripple"><a href="<?php echo site_url('Jadwal') ?>"><span class="fa fa-calendar-o"></span>Jadwal
						Dokter</a></li>

				<?php if ($this->session->userdata('level') == 'admin') : ?>

					<li class="ripple"><a href="<?php echo site_url('Dokter') ?>"><span class="fa fa-hospital-o"></span>Dokter</a>
					</li>
	...
	<!-- 				<li class="ripple"><a href="<?php echo site_url('laporan') ?>"><span
									class="fa fa-pencil-square-o "></span>Laporan</a></li> -->
				<?php endif; ?>
